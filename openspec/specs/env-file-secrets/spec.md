# env-file-secrets Specification

## Purpose
Defines how the application loads and persists secrets (API keys) using a `.env` file in the XDG config directory, replacing the platform keyring with a portable, file-based approach.
